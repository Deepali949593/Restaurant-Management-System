...
<body>
    ...
    <a class="nav-link" href="../../customerSide/home/home.php"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> Delicious</h1><span class="sr-only"></span></a>
    ...
    <form action="login_process.php" method="post" >
        <div class="form-group">
            <label for="account_id">Admin</label> ID</label>
