    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> DELICIOU'S </h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
        ...
        <ul>
          ...
          <li><a href="../../adminSide/StaffLogin/login.php" data-after="Staff">Admin</a></li>
...
<section id="hero" style="position: relative;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" color:whitesmoke;> "Savor the moment</h1><span></span></strong></h1>
            <h1><strong style="color:white;">one delicious bite at a time"<span></span></strong></h1>
...
<section id="about">
  <div class="about container">
    <div class="col-right">
        ...
        <h2>DELICIOUS Company History:</h2>
 <p>DELICIOUS is a well-established Western food establishment in the city's heart. DELICIOUS has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing meal, with a focus on providing delicious meals and a friendly dining experience.
 </p>
 <p>DELICIOUS, as a Western restaurant, offers a diverse menu that caters to a variety of tastes. The menu includes a wide range of options such as momo, salads, soups and a variety of main courses. Customers can savour succulent options such as chicken, chilly, seafood, burgers and sandwiches, pasta, and a variety of delectable side dishes. The menu has been carefully curated to offer a balance of classic favourites and innovative creations, ensuring that every palate is satisfied.
 </p>
 <p>DELICIOUS's ability to accommodate customers is one of its distinguishing features. DELICIOUS strives to create an inviting and comfortable dining environment, whether guests prefer to walk in or make reservations in advance. The restaurant recognises the significance of creating memorable experiences, particularly for those celebrating special occasions. DELICIOUS is a popular choice for families, couples, and groups of friends because of its attentive staff and welcoming atmosphere.
 </p>
 <p>DELICIOUS has an inviting outdoor restaurant that is open seven days a week from 11:00 AM to 10:00 PM in addition to the indoor dining area.This outdoor space provides a relaxed setting for patrons to unwind and socialise while sipping on their favourite drinks 
      </div>
    </div>
  </section>
  <!-- End About Section -->
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg"> 
        <div class="contact-info">
          ...
          <ul>
  <li>
    <a href="mailto:Deeps805023@gmail.com" style="color: white; text-decoration: none; ">
      Deeps805023@gmail.com
    </a>
  </li>
  <li>
    <a href="mailto:Jaisonjsamuel007@gmail.com" style="color: white; text-decoration: none;">
      Jaisonjsamuel007@gmail.com
    </a>
  </li>
</ul>
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>
  <a href="https://www.google.com/maps/place/Horamavu,+Bengaluru,+Karnataka" target="_blank" style="color: white; text-decoration: none;">
    Horamavu, Bangalore
  </a>
</h2>
...
<section id="timing" aria-labelledby="timing-heading">
  <div class="timing container">
    <div>
      <h1 id="timing-heading" class="section-title">Restaurant <span>Timings</span></h1>
    </div>
    <div class="timing-items" role="list">
      <div class="timing-item" role="listitem"><h2>Monday</h2> <p>10:00 AM - 10:00 PM</p></div>
      <div class="timing-item" role="listitem"><h2>Tuesday</h2> <p>10:00 AM - 10:00 PM</p></div>
      <div class="timing-item" role="listitem"><h2>Wednesday</h2> <p>10:00 AM - 10:00 PM</p></div>
      <div class="timing-item" role="listitem"><h2>Thursday</h2> <p>10:00 AM - 10:00 PM</p></div>
      <div class="timing-item" role="listitem"><h2>Friday</h2> <p>10:00 AM - 10:00 PM</p></div>
      <div class="timing-item" role="listitem"><h2>Saturday</h2> <p>9:00 AM - 11:00 PM</p></div>
      <div class="timing-item" role="listitem"><h2>Sunday</h2> <p>9:00 AM - 11:00 PM</p></div>
    </div>
  </div>
</section>
<!-- End Restaurant Timing Section -->
...
.menu-category:hover {
  ...
  color: white; /* Black text on hover */
    ...
    .item-name {
  display: inline; /* Ensure items are displayed on separate lines */
  width: 100%; /* Adjust the width as needed */
  float: left;
}

.item-price {
  display: inline; /* Ensure prices are displayed on separate lines */
